...
| Plans API | `/recast:plans-api` | Creates Plans (from scratch or from a successful optimization), edits a plan by adding a new version, and reads Plans, versions, budgets, forecasts/counterfactuals, spend adherence, and Goal pacing |
